...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Punch-list collected (user seeds + dogfood pass) and frozen; each item triaged trivial-inline vs spun-out
...
Marked Done 2026-06-21 — hardening pass-1 (home navbar, sensor content-box + size/border, peek dwell-spawn + upward-cone fling, parked-word wobble fix) merged to main; punch-list frozen. 'Kept→box-edge' (B) continues in task-035 (AC#6).
<!-- SECTION:NOTES:END -->
